...
""",
    ...
    func getFileData() -> [City]{
        ...
        if let filePath = Bundle.main.url(forResource: "DemoData", withExtension: "json"){
            ...
            do {
                ...
                do {
                    let citites = try decoder.decode([City].self, from: data)
                    return citites
                }
                catch {
                    print("Couldn't parse the file: \(error)")
